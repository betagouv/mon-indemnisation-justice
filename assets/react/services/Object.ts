        ...
        Object.entries(original).map(([key, value]) => {
            if (patch.hasOwnProperty(key)) {
                ...
                if (value instanceof Object) {
                    return patch[key] instanceof Object ? [key, recursivePatch(value, patch[key])] : [key, value];
                }
...
export function recursiveMerge(original: object, addition: object): object {
    return Object.fromEntries(
        Object
            ...
            .keys(original).concat(Object.keys(addition))
            // ... dédoublonnés ...
            .reduce(
                (keys: string[], next: string) => {
            ...
            .map(
                (key) => {
                    if (!original.hasOwnProperty(key)) {
                        ...
                        if (original[key] instanceof Object && addition[key] instanceof Object) {
