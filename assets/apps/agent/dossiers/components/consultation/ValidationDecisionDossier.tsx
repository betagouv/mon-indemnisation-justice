...
export const ValidationDecisionDossier = observer(
  function ValidationDecisionDossierComponent({
    dossier,
    onEdite,
    onSigne,
  }: {
        ...
        if (response.ok) {
          ...
          if (data.documents.courrier_ministere?.length) {
            dossier.addDocument(
              plainToInstance(
                Document,
                data.documents.courrier_ministere?.at(0),
              ),
            );
          }
          if (data.etat) {
                        ...
                        {dossier.estAccepte() &&
                          ...
                          montantIndemnisation !== montantIndemnisationLu && (
                            <div className="fr-alert fr-alert--warning">
                              ...
                              <p>
                                Puisque la valeur déclarée dans le champs
                                "Montant de l'indemnisation" sera également
                                mentionnée sur le formulaire de déclaration
                                d'acceptation, il y a un risque d'ambigüité pour
                                le requérant.
                              </p>

                              <p>
                                Veillez donc à bien accorder les montants dans
                                le courrier (en chiffres ainsi qu'en toutes
                                lettres).
                              </p>
                            </div>
                          )}
