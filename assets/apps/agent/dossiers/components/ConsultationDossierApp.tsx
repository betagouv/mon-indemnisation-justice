...
import {Agent, Document, DocumentType, DossierDetail,} from "@/apps/agent/dossiers/models";
import {ValidationDecisionDossier,} from "@/apps/agent/dossiers/components/consultation";
