                ...
                <td colSpan="4">
                    {!actif ?
                        <ul className="fr-btns-group fr-btns-group--inline-md fr-btns-group--center">
                            <li>
                                <button type="button" className="fr-btn fr-my-2w" onClick={() => setActif(true)}>Ajouter
                                    un agent
                                </button>
                            </li>
                        </ul> :
                            ...
                            <div className="fr-col-12">
                                <fieldset
                                    ...
                                    <div className="fr-grid-row fr-col-12 fr-mb-2w">
                                        ...
                                        <p className="fr-m-1w">
                                            L'agent que vous créez disposera de toutes les permissions que vous
                                            lui accordez ici dès sa première connexion.
                                        </p>
                                    </div>
                                        ...
                                        <div className="fr-col-4">
                                            <div className="fr-fieldset__element">
                                                <div className="fr-input-group" id="input-group-81">
                                                    <label className="fr-label"
                                                           htmlFor="input-66">Nom<span
                                                        className="fr-hint-text">&zwnj;</span>
                                                    </label>
                                            ...
                                            <div className="fr-fieldset__element">
                                                <div className="fr-input-group" id="input-group-82">
                                                    ...
                                                    <input className="fr-input"
                                                           ...
                                                           id="input-67" type="text"/>
                                                    {erreur && <div className="fr-messages-group fr-message--error"
