...
#[AsCommand(name: 'mij:decouper:declaration', description: "Temporaire: découper les déclarations d'acceptation")]
class DecouperDeclarationAcceptationCommand extends Command
{
