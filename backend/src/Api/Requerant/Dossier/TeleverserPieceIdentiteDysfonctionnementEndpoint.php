...
#[Route('/api/requerant/dossier/dysfonctionnement/{reference}/televerser-pieces-jointes', name: 'api_requerant_dossier_dysfonctionnement_televerser_pieces_jointes', methods: ['POST'])]
...
class TeleverserPieceIdentiteDysfonctionnementEndpoint
{
