...
use MonIndemnisationJustice\Api\Agent\Resources\Output\DossierAAttribuerOutput;
 ...
 */
#[Route('/api/agent/dossiers/liste/a-instruire', name: 'api_agent_dossiers_liste_a_instruire', methods: ['GET'])]
#[IsGranted('lister:dossiers:a-instruire')]
class ListeDossierAInstruireEndpoint
{
