...
use MonIndemnisationJustice\Api\Agent\Resources\Output\DossierAVerifierOutput;
 ...
 */
#[Route('/api/agent/dossiers/liste/a-verifier', name: 'api_agent_dossiers_liste_a_vérifier', methods: ['GET'])]
#[IsGranted('lister:dossiers:a-verifier')]
