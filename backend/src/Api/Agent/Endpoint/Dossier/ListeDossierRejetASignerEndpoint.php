...
use MonIndemnisationJustice\Api\Agent\Resources\Output\DossierRejetASignerOutput;
 ...
 */
#[Route('/api/agent/dossiers/liste/rejet-a-signer', name: 'api_agent_dossiers_liste_rejet_a_signer', methods: ['GET'])]
#[IsGranted('lister:dossiers:rejet-a-signer')]
