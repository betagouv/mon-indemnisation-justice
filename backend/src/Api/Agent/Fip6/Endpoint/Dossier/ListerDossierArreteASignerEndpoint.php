...
use MonIndemnisationJustice\Api\Agent\Fip6\Output\DossierArreteASignerOutput;
 ...
 */
#[Route('/api/agent/fip6/dossiers/liste/arrete-a-signer', name: 'api_agent_dossiers_liste_arrete_a_signer', methods: ['GET'])]
...
class ListerDossierArreteASignerEndpoint
{
    ...
    {
        $dossiers = $this->entityManager->getRepository(Dossier::class)->listerDossierParEtat(EtatDossierType::DOSSIER_OK_VERIFIE);
        ...
        return new JsonResponse(
            $this->normalizer->normalize(
                array_map(
                    ...
                    */
                    fn (Dossier $dossier) => DossierArreteASignerOutput::creerDepuisDossier($dossier),
                    $dossiers
                ),
                'json'
            )
