...
use MonIndemnisationJustice\Api\Agent\Fip6\Output\DossierDeclarationAcceptationAVerifierOutput;
 ...
 */
#[Route('/api/agent/fip6/dossiers/liste/acceptation-a-verifier', name: 'api_agent_dossiers_liste_a_vérifier', methods: ['GET'])]
#[IsGranted(DossierVoter::ACTION_LISTER_ACCEPTATION_A_VERIFIER)]
class ListerDossierDeclarationAcceptationAVerifierEndpoint
{
        ...
        return new JsonResponse(
            $this->normalizer->normalize(
                array_map(
                    ...
                    */
                    fn (Dossier $dossier) => DossierDeclarationAcceptationAVerifierOutput::creerDepuisDossier($dossier),
                    array_values($agent->getDossiersDeclarationAcceptationAVerifier())
                ),
                'json',
            )
        );
