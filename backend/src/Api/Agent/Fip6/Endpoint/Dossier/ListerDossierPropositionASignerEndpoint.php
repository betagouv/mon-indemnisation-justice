...
use MonIndemnisationJustice\Api\Agent\Fip6\Output\DossierPropositionASignerOutput;
 ...
 */
#[Route('/api/agent/fip6/dossiers/liste/proposition-a-signer', name: 'api_agent_dossiers_liste_proposition_a_signer', methods: ['GET'])]
...
class ListerDossierPropositionASignerEndpoint
{
    ...
    {
        $dossiers = $this->entityManager->getRepository(Dossier::class)->listerDossierParEtat(EtatDossierType::DOSSIER_OK_A_SIGNER);
        ...
        return new JsonResponse(
            $this->normalizer->normalize(
                array_map(
                    ...
                    */
                    fn (Dossier $dossier) => DossierPropositionASignerOutput::creerDepuisDossier($dossier),
                    $dossiers
                ),
                'json'
            )
