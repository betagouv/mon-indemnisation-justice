...
class AttestationsController extends AbstractController
{
    ...
    {
        return new BinaryFileResponse($this->assetsDirectory.'/attestations/v1/attestation-a-remettre-en-cas-d-erreur-de-porte.pdf');
    }
    ...
    {
        return new BinaryFileResponse($this->assetsDirectory.'/attestations/v1/guide-de-remise-de-l-attestation.pdf');
    }
}
