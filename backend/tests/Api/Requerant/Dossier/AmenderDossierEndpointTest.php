...
class AmenderDossierEndpointTest extends WebTestCase
{
    ...
    public function testAmenderDossierOk()
    {
        ...
        /** @var Dossier $dossier */
        $dossier = $usager->getDossiers()->filter(fn(Dossier $d) => DossierType::BRIS_PORTE === $d->getType() && EtatDossierType::DOSSIER_A_FINALISER === $d->getEtatDossier()->getEtat())->first();
        ...
        $dossier = $this->em->find(Dossier::class, $dossier->getId());
