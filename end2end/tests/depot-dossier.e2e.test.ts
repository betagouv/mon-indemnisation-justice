...
test("dépôt de dossier", async ({ browser }) => {
  ...
  await selectionnerMenu(
    page,
    "Vous effectuez votre demande en qualité de ",
  ...
  await page
    .locator("button", { hasText: "Ajouter des photos de la porte endommagée" })
    .click();

  // Sélectionner 1 fichier puis s'assurer que le type est déjà sélectionné puis valider
  await page
    .getByLabel("Documents à téléverser")
    .setInputFiles(path.join(__dirname, "./ressources/photo-porte-2.jpeg"));

  await page.locator("button", { hasText: "Prévisualiser" }).click();
  await expect(
    page.locator("h5", { hasText: "Fichier : photo-porte-2.jpeg" }),
  ).toBeVisible();
  await expect(page.getByLabel("Type de pièce jointe")).toHaveValue(
    "photo_prejudice",
  );
  ...
  await expect(
    page.locator("h3.fr-alert__title", {
      hasText: "Des documents sont manquants",
    }),
  ).toBeVisible();
  ...
  await page
    ...
    .setInputFiles([
      ...
      path.join(__dirname, "./ressources/cni.jpg"),
      path.join(__dirname, "./ressources/facture-1.png"),
  ...
  await expect(
    page.locator("h2.fr-stepper__title", {
      hasText:
        "Fichier n°1 : attestation_completee_par_les_forces_de_l_ordre.pdf",
    }),
  ).toBeVisible();
  ...
  await expect(
    page.locator("h2.fr-stepper__title", { hasText: "Fichier n°2 : cni.jpg" }),
  ).toBeVisible();
  await selectionnerMenu(page, "Type de pièce jointe", {
  ...
  await expect(
    page.locator("h2.fr-stepper__title", {
      hasText: "Fichier n°3 : facture-1.png",
    }),
  ).toBeVisible();
  ...
  await expect(
    page.locator("h2.fr-stepper__title", { hasText: "Fichier n°4 : rib.jpg" }),
  ).toBeVisible();
  ...
  await expect(
    page.locator("h2.fr-stepper__title", {
      hasText: "Fichier n°5 : acte_de_propriete.pdf",
    }),
  ).toBeVisible();
  await selectionnerMenu(page, "Type de pièce jointe", {
  ...
  await expect(
    page.locator("h2.fr-stepper__title", {
      hasText: "Fichier n°6 : sample-4.pdf",
    }),
  ).toBeVisible();
  await selectionnerMenu(page, "Type de pièce jointe", {
  ...
  await page.waitForSelector("dialog#ajouter-pieces-jointes-modale", {
    state: "hidden",
  });
  ...
  await expect(
    page.locator("h2", { hasText: "Récapitulatif de la demande" }),
  ).toBeVisible();
  ...
  await expect(
    page.locator("h3.fr-alert__title", {
      hasText: "Votre dossier a bien été déposé",
    }),
  ...
  await page.waitForSelector("dialog#dossier-depose-modale", {
    state: "hidden",
  });
