          ...
          case "personne-morale":
            return (
              <QuestionChoix<"oui" | "non">
                ...
                valeur={
                  etat.typePersonne === TypePersonne.Morale
                    ? "oui"
                    : etat.typePersonne === TypePersonne.Physique
                      ? "non"
                      : undefined
                }
                options={[
          ...
          case "deja-inscrit":
            return (
              <QuestionChoix<"oui" | "non">
                ...
                valeur={
                  etat.dejaInscrit === true
                    ? "oui"
                    : etat.dejaInscrit === false
                      ? "non"
                      : undefined
                }
                options={[
                ...
                onReponse={(reponse) =>
                  modifier(repondreDejaInscrit(etat, reponse === "oui"))
                }
              />
            );
