...
} from "@/apps/agent/dossiers/components/consultation/piecejointe/MetaDonneesAttestation";
                                                ...
                                                <ul className="fr-list">
                                                    ...
                                                    <li>
                                                        ...
                                                        !agent.estBetagouv() ? (
                                                            <>
                                                                <span
                                                                    aria-describedby="tooltip-requerant-courriel">{`${dossier.requerant.courriel.substring(0, 2)}${"*".repeat(dossier.requerant.courriel.length - 2)}`}</span>
                                                                <span
                                                                    className="fr-tooltip fr-placement"
                                                        ...
                                                        {dossier.requerant.telephone ? (
                                                            <>
                                                                ...
                                                                !agent.estBetagouv() ? (
                                                                    <>
                                                                        <span
                                                                            aria-describedby="tooltip-requerant-telephone">{`${dossier.requerant.telephone.substring(0, 2)}${"*".repeat(dossier.requerant.telephone.length - 2)}`}</span>
                                                                        <span
                                                                            className="fr-tooltip fr-placement"
