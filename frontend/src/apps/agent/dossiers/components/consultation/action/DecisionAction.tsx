...
class EtapeDecision {
    ...
    public static VERIFICATION_PI = new EtapeDecision(4, "Vérifier et valider les informations");
    public static EDITION_DECLARATION_ACCEPTATION = new EtapeDecision(3, "Éditer la déclaration d'acceptation", EtapeDecision.VERIFICATION_PI);
    public static EDITION_COURRIER_PI = new EtapeDecision(2, "Éditer de la proposition d'indemnisation", EtapeDecision.EDITION_DECLARATION_ACCEPTATION);
    public static CHOIX_MONTANT_INDEMNISATION = new EtapeDecision(1, "Définir le montant de l'indemnisation", EtapeDecision.EDITION_COURRIER_PI);
    public static VERIFICATION_REJET = new EtapeDecision(3, "Vérifier et valider les informations");
    public static EDITION_COURRIER_REJET = new EtapeDecision(2, "Éditer du courrier de rejet", EtapeDecision.VERIFICATION_REJET);
    public static readonly CHOIX_MOTIF_REJET = new EtapeDecision(1, "Définir le motif de refus", EtapeDecision.EDITION_COURRIER_REJET);

    private constructor(public readonly rang: number, public readonly titre: string, public readonly suivant: EtapeDecision | null = null) {
    }
...
const DefinirMotifRefus = ({ motifRejet, setMotifRejet
                           }: {
...
const DefinirMontantIndemnisation = ({montantIndemnisation, setMontantIndemnisation}: {
    montantIndemnisation: number,
    setMontantIndemnisation: Dispatch<SetStateAction<number>>
}) => {
    return <div className="fr-input-group fr-col-12">
        <label
            className="fr-label"
    ...
    return estEnAttenteDecision({dossier, agent}) && dossier.enInstruction() ? (
        ...
        >
            ...
            {etatDecision.etape === EtapeDecision.CHOIX_MOTIF_REJET && (
                <>
                    <DefinirMotifRefus motifRejet={etatDecision.motifRefus} setMotifRejet={etatDecision.opterRejet}/>
                    <ButtonsGroup
