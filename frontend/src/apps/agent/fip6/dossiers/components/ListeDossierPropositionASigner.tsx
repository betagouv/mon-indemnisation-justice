...
import { DossierPropositionASigner } from "./liste/DossierPropositionASigner.ts";
...
export function ListeDossierPropositionASigner() {
  ...
  return (
    <>
      <h1>
        Dossiers en attente de signature de la proposition d'indemnisation
      </h1>
      ...
      <div>
        {dossiers.map((dossier: DossierPropositionASigner) => (
          <DossierPropositionASignerLigne
