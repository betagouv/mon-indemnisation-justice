...
export const TestEligibiliteForm = (
    ...
    const refQuestionRapportAuLogement = useRef(null);
    ...
    const isMobile = useMemo(
        () => windowInnerWidth < breakpointsValues.sm, [windowInnerWidth, breakpointsValues]);
            ...
            {estDecide && (
                <div ref={refDecision}>
                    {estDecide &&
                        ...
                        (test.rapportAuLogement !== 'locataire' || test.aContacteBailleur) && (
                            <Alert
                                severity="success"
