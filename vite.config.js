...
export default defineConfig(({command, mode}) => {
    ...
    return {
        ...
        plugins: [legacy({
            ...
            originOverride: "https://mon-indemnisation.justice.gouv.dev", stimulus: false, build: {
                manifest: true, outDir,
            },
        }), reactPlugin(), copy({
            targets: [{src: "node_modules/@gouvfr/dsfr/dist/*", dest: "public/dsfr"}, {
        ...
        esbuild: false, build: {
            outDir, target: "es2015", modulePreload: false, sourcemap: false, rollupOptions: {
                ...
                input: {
                    ...{
                        "requerant/dossier/tester_mon_eligibilite": "./assets/apps/requerant/dossier/tester_mon_eligibilite.ts",
                        "requerant/dossier/creation_de_compte": "./assets/apps/requerant/dossier/creation_de_compte.ts",
                        "requerant/dossier/deposer_mon_dossier": "./assets/apps/requerant/dossier/deposer_mon_dossier.tsx",
